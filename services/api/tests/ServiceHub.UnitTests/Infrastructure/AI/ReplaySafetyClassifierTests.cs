...
public class ReplaySafetyClassifierTests
{
    ...
    public void Classify_Transient_LowDelivery_ReturnsSafe()
    {
        ...
        result.Should().Be(ReplaySafetyLevels.Safe);
    }
    ...
    public void Classify_Transient_HighDelivery_ReturnsRequiresReview()
    {
        ...
        result.Should().Be(ReplaySafetyLevels.RequiresReview);
    }
    ...
    public void Classify_Expired_ReturnsUnsafe()
    {
        ...
        result.Should().Be(ReplaySafetyLevels.Unsafe);
    }
    ...
    {
        ReplaySafetyLevels.Safe.Should().Be("Safe");
        ReplaySafetyLevels.Unsafe.Should().Be("Unsafe");
        ReplaySafetyLevels.RequiresReview.Should().Be("RequiresReview");
    }
}
