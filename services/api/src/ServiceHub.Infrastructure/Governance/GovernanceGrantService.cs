...
public sealed class GovernanceGrantService : IGovernanceGrantService
{
    ...
    private readonly IAuditTrail _auditService;
    private readonly ILogger<GovernanceGrantService> _logger;

    public GovernanceGrantService(ServiceHubDbContext dbContext, IAuditTrail auditService, ILogger<GovernanceGrantService> logger)
    {
