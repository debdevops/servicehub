...
/// <param name="MaxMessages">Maximum number of messages to retrieve (1-1000).</param>
...
public sealed record GetMessagesRequest(
    ...
    [Range(1, 1000, ErrorMessage = "MaxMessages must be between 1 and 1000")]
    int MaxMessages = 100,
    ...
    long? FromSequenceNumber = null)
{
    ...
    /// </summary>
    public const int MaxAllowedMessages = 1000;
