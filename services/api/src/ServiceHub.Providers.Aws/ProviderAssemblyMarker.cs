...
/// archive at unit 1.4 (PORTING-MAP P18). Until then this type exists so the project is
...
public static class ProviderAssemblyMarker
{
    ...
    public static CloudProviderType Provider => CloudProviderType.Aws;
    ...
    /// </summary>
    public static ProviderCapabilities Capabilities => ProviderCapabilities.Aws;
}
