...
/// archive at unit 1.3 (PORTING-MAP P17). Until then this type exists so the project is
...
public static class ProviderAssemblyMarker
{
    ...
    public static CloudProviderType Provider => CloudProviderType.Azure;
    ...
    /// </summary>
    public static ProviderCapabilities Capabilities => ProviderCapabilities.Azure;
}
