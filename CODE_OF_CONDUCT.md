...
reported to the project maintainer, [@debdevops](https://github.com/debdevops),
by opening a [private GitHub Security Advisory](https://github.com/debdevops/servicehub/security/advisories/new)
or by direct message on GitHub. All complaints will be reviewed and
investigated promptly and fairly, and the reporter's identity and report
...
1. **Correction** — A private, written warning for an isolated incident of
   unprofessional behavior, with a request for a public apology if appropriate.
